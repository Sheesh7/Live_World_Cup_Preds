...
* **Time Decay and State Gravity:** Using the proportion of time remaining ($\tau = \frac{90 - t}{90}$), probabilities are bound to live score states
* $$gd = \text{Score}_{\text{Home}} - \text{Score}_{\text{Away}}$$
